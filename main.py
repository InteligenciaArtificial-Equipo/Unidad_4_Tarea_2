...
def main():
    ...
    # 1. Preprocesamiento de Datos y Division
    ...
    print("\nVisualizando un ejemplo de extraccion de caracteristicas")
    ...
    # 3. Deteccion de Emociones en Tiempo Real
    print("\n---")
